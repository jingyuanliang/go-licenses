...
import (
	...
	"github.com/jingyuanliang/go-licenses/internal/third_party/pkgsite/source"
...
func (l *Library) FileURL(ctx context.Context, filePath string) (string, error) {
	...
	if m.Version == "" {
		...
		// * I have a module at github.com/jingyuanliang/go-licenses/submod.
		...
		// Examples:
		// * https://github.com/jingyuanliang/go-licenses/blob/HEAD/LICENSE
	...
	// https://github.com/jingyuanliang/go-licenses/issues/73#issuecomment-1005587408
